...
public class StmergeApplication {
    public static ControllerCentre controllerCentre;
    public static PbftNode pbftNode;
    public static void main(String[] args) throws FileNotFoundException {
        SpringApplication.run(StmergeApplication.class, args);
//        pbftNode = new PbftNode(3, "127.0.0.1", 9004, true);
//        pbftNode.start();
        controllerCentre = new ControllerCentre(-1, "127.0.0.1", 9000);
